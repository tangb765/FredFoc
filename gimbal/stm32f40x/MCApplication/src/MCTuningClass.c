...
CPID_PI MCT_GetPosLoopPID(CMCT this)
{
  return (((_CMCT)this)->Vars_str.MCTuningInitStruct.oPIDPos);
}

CPI MCT_GetPosLoopPI(CMCT this)
{
  return (CPI)(((_CMCT)this)->Vars_str.MCTuningInitStruct.oPIDPos);
}
