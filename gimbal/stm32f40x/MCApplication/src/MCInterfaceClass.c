...
{
  pVars_t pVars = CLASS_VARS;
  bool RetVal = STM_NextState(((_CMCI)this)->Vars_str.oSTM,START); //IDLE_START  DRF-UPD
...
void MCI_SetMecSpeedRef01Hz(CMCI this,int16_t speed)
{
  pVars_t pVars = CLASS_VARS;
  STC_SetMecSpeedRef01Hz(pVars->oSTC,speed);
}
