...
static volatile rt_int16_t Encoder_pos = 0;
...
//	return  (rt_int16_t)(SPD_GetMecAngle(oSPD) - configs.level_mec_angle);
	return (rt_int16_t)((Encoder_pos<<1) - configs.level_mec_angle);
}
