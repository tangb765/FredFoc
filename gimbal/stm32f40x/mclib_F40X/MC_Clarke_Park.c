...
static const rt_uint16_t circle_limit_table[91]=     
{
...
static const rt_uint16_t circle_limit_table[89]=     
{
...
static const rt_uint16_t circle_limit_table[87]=     
{
...
static const rt_uint16_t circle_limit_table[84]=     
{
...
static const rt_uint16_t circle_limit_table[82]=     
{
...
static const rt_uint16_t circle_limit_table[81]=     
{
...
static const rt_uint16_t circle_limit_table[78]=     
{
...
static const rt_uint16_t circle_limit_table[76]=     
{
...
const rt_uint16_t circle_limit_table[74]=     
{
...
const rt_uint16_t circle_limit_table[73]=     
{
...
const rt_uint16_t circle_limit_table[72]=     
{
...
const rt_uint16_t circle_limit_table[71]=     
{
...
const rt_uint16_t circle_limit_table[70]=     
{
...
const rt_uint16_t circle_limit_table[68]=     
{
...
const rt_uint16_t circle_limit_table[67]=     
{
...
const rt_uint16_t circle_limit_table[66]=     
{
...
const rt_uint16_t circle_limit_table[65]=     
{
...
#define SIN_MASK 0x6000
//#define U0_90     0x4000
//#define U90_180   0x6000
//#define U180_270  0x0000 
//#define U270_360  0x2000

#define U0_90     0x0000
#define U90_180   0x2000
#define U180_270  0x4000
#define U270_360  0x6000
...
const rt_int16_t hSin_Cos_Table[8192] = SIN_COS_TABLE2;
//const rt_int16_t hSin_Cos_Table[512] = SIN_COS_TABLE;
...
Curr_Components Clarke(Curr_Components Curr_Input)
{
  ...
  rt_int32_t qIa_divSQRT3_tmp;
  rt_int32_t qIb_divSQRT3_tmp ;
  
  rt_int16_t qIa_divSQRT3;
  rt_int16_t qIb_divSQRT3 ;
  ...
  qIa_divSQRT3=((rt_int16_t)(qIa_divSQRT3_tmp));		
  		
  qIb_divSQRT3=((rt_int16_t)(qIb_divSQRT3_tmp));				
...
Curr_Components Park(Curr_Components Curr_Input, rt_int16_t Theta)
{
  Curr_Components Curr_Output;
  rt_int32_t qId_tmp_1, qId_tmp_2;
  rt_int32_t qIq_tmp_1, qIq_tmp_2;     
  rt_int16_t qId_1, qId_2;  
  rt_int16_t qIq_1, qIq_2;  
  ...
  qIq_1 = ((rt_int16_t)(qIq_tmp_1));
  qIq_2 = ((rt_int16_t)(qIq_tmp_2));
  ...
  qId_1 = (rt_int16_t)(qId_tmp_1);		
  
  qId_2 = (rt_int16_t)(qId_tmp_2);					
...
if ( temp > (rt_uint32_t)(( MAX_MODULE * MAX_MODULE) ) ) // (Vd^2+Vq^2) > MAX_MODULE^2 ?
   {
   rt_uint16_t index;
              
   temp /= (rt_uint32_t)(512*32768);  // min value START_INDEX, max value 127
   temp -= START_INDEX ;   // min value 0, max value 127 - START_INDEX
   index = circle_limit_table[(rt_uint8_t)temp];
              
   temp = (rt_int16_t)Stat_Volt_q_d.qV_Component1 * (rt_uint16_t)(index); 
   Stat_Volt_q_d.qV_Component1 = (rt_int16_t)(temp/32768);  
              
   temp = (rt_int16_t)Stat_Volt_q_d.qV_Component2 * (rt_uint16_t)(index); 
   Stat_Volt_q_d.qV_Component2 = (rt_int16_t)(temp/32768);  
   }
...
{ 	
  rt_int32_t qValpha_tmp1,qValpha_tmp2,qVbeta_tmp1,qVbeta_tmp2;
  rt_int16_t qValpha_1,qValpha_2,qVbeta_1,qVbeta_2;
  ...
  qValpha_1 = (rt_int16_t)(qValpha_tmp1);		
  qValpha_2 = (rt_int16_t)(qValpha_tmp2);			
  ...
  qVbeta_1 = (rt_int16_t)(qVbeta_tmp1);				
  qVbeta_2 = (rt_int16_t)(qVbeta_tmp2);
...
*                  angle
* Input          : angle in rt_int16_t format
* Output         : Cosine and Sine in rt_int16_t format
* Return         : none.
*******************************************************************************/
Trig_Components Trig_Functions(rt_int16_t hAngle)
{
  rt_uint16_t hindex;
  Trig_Components Local_Components;
  
  /* 10 bit index computation  */  
//  hindex = (rt_uint16_t)(hAngle + 32768);  
	hindex = (rt_uint16_t)(hAngle);  
  hindex /= 2;      
  
//  switch (hindex & SIN_MASK) 
//  {
//  case U0_90:
//    Local_Components.hSin = hSin_Cos_Table[(rt_uint8_t)(hindex)];
//    Local_Components.hCos = hSin_Cos_Table[(rt_uint8_t)(0xFF-(rt_uint8_t)(hindex))];
//    break;
//  
//  case U90_180:  
//     Local_Components.hSin = hSin_Cos_Table[(rt_uint8_t)(0xFF-(rt_uint8_t)(hindex))];
//     Local_Components.hCos = -hSin_Cos_Table[(rt_uint8_t)(hindex)];
//    break;
//  
//  case U180_270:
//     Local_Components.hSin = -hSin_Cos_Table[(rt_uint8_t)(hindex)];
...
//  }
  ...
  {
  case U0_90:
    Local_Components.hSin = hSin_Cos_Table[(hindex&0x1FFF)];
    Local_Components.hCos = hSin_Cos_Table[(0x1FFF-((hindex)&0x1FFF))];
    break;
  
  case U90_180:  
     Local_Components.hSin = hSin_Cos_Table[(0x1FFF-((hindex)&0x1FFF))];
     Local_Components.hCos = -hSin_Cos_Table[(hindex&0x1FFF)];
    break;
