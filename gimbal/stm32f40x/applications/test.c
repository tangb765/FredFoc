...
//				rt_kprintf("%c:%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\r\n", board,motor_state,Stat_Curr_a_b.qI_Component1,Stat_Curr_a_b.qI_Component2,Stat_Curr_alfa_beta.qI_Component1,Stat_Curr_alfa_beta.qI_Component2,
//			Stat_Volt_q_d.qV_Component1,Stat_Volt_q_d.qV_Component2,Stat_Volt_alfa_beta.qV_Component1,Stat_Volt_alfa_beta.qV_Component2,Get_Mec_Angle_Value());	
				break;
