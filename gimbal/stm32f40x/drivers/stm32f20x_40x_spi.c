...
//	
//	stm32_spi_cs_mpu6500.GPIOx = GPIOC;
...
//	stm32_spi_cs_ms5611.GPIOx = GPIOC;
//	stm32_spi_cs_ms5611.GPIO_Pin = GPIO_Pin_5;
...
//	/*init mpu6500ex spi */
//	static struct rt_spi_device rt_spi_device_mpu6500ex;
//	static struct stm32_spi_cs  stm32_spi_cs_mpu6500ex;	
//	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);

//	stm32_spi_cs_mpu6500ex.GPIOx = GPIOD;
//	stm32_spi_cs_mpu6500ex.GPIO_Pin = GPIO_Pin_10;
...
//	rt_spi_bus_attach_device(&rt_spi_device_mpu6500ex, "mpu6500ex", "spi1", (void*)&stm32_spi_cs_mpu6500ex);
...
//SPI2
	...
	stm32_spi_cs_mpu6500.GPIOx = GPIOB;
	stm32_spi_cs_mpu6500.GPIO_Pin = GPIO_Pin_12;
	...
	rt_spi_bus_attach_device(&rt_spi_device_mpu6500, "mpu6500","spi2", (void*)&stm32_spi_cs_mpu6500);
...
//	stm32_spi_cs_flash.GPIOx = GPIOA;
//	stm32_spi_cs_flash.GPIO_Pin = GPIO_Pin_15;
...
//	
//	rt_spi_bus_attach_device(&rt_spi_device_flash, "flash_bus","spi3", (void*)&stm32_spi_cs_flash);
