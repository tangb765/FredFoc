...
static void R1F30X_Init(CPWMC this)
{
  ...
  if (pDOCP_COMPParams_str)
  {
    ...
    {
      if (pDOCP_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC1)
      {
        R1F30X_SetAOReferenceVoltage(DAC_Channel_1, (uint16_t)(pDParams_str->hDAC_OCP_Threshold));
      }
      else if (pDOCP_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC2)
      {
  ...
  if (pDOVP_COMPParams_str)
  {
    ...
    {
      if (pDOVP_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC1)
      {
        R1F30X_SetAOReferenceVoltage(DAC_Channel_1, (uint16_t)(pDParams_str->hDAC_OVP_Threshold));
      }
      else if (pDOVP_COMPParams_str->wInvertingInput == COMP_InvertingInput_DAC2)
      {
  ...
  else
  {
    ...
    ADC_CommonInit(ADC1, &ADC_CommonInitStructure); /*ADC3 here stands for ADC3&4*/ 
  }  
...
static void R1F30X_SetAOReferenceVoltage(uint32_t DAC_Channel, uint16_t hDACVref)
{
  ...
  {
    DAC_SetChannel2Data(DAC_Align_12b_L,hDACVref);
  }
  else
  {
    DAC_SetChannel1Data(DAC_Align_12b_L,hDACVref);
  }  
