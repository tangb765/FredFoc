...
static int16_t HALL_CalcElAngle(CSPD this, void *pInputVars_str, int32_t Aligned_num, uint8_t bMotorNbr);
...
static int32_t HALL_SetMecAngle(CSPD this, int16_t hMecAngle);
