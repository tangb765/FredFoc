...
int16_t PI_Controller(CPI this, int32_t wProcessVarError)
{
  ...
  wOutput_32 = (wProportional_Term/(int32_t)((_CPI)this)->pParams_str->
                hKpDivisor)+(((_CPI)this)->Vars_str.wIntegralTerm/(int32_t)
                ((_CPI)this)->pParams_str->hKiDivisor);
#else    
 /* WARNING: the below instruction is not MISRA compliant, user should verify
             that Cortex-M3 assembly instruction ASR (arithmetic shift right) 
             is used by the compiler to perform the shifts (instead of LSR 
             logical shift right)*/ 
  wOutput_32 = (wProportional_Term >>((_CPI)this)->pParams_str->hKpDivisorPOW2) + 
  (((_CPI)this)->Vars_str.wIntegralTerm >> ((_CPI)this)->pParams_str->hKiDivisorPOW2);
#endif
...
{
  return (((_CPI)this)->pParams_str->hKpDivisor);
}
...
{
  return (((_CPI)this)->pParams_str->hKiDivisor);  
}
