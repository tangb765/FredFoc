...
{
#if (defined ENCODER)	
	((_CSPD)this)->Vars_str.bIs_First_Measurement = TRUE;
#endif
...
/**
  ...
  * @retval none
  */
int32_t SPD_SetMecAngle(CSPD this, int16_t hMecAngle)
{
  return ((_CSPD)this)->Methods_str.pSPD_SetMecAngle(this,hMecAngle);  
}
...
/**
  ...
  * @retval int16_t rotor electrical angle (s16Degrees)
  */
int16_t SPD_CalcAngle(CSPD this, void *pInputVars_str, int32_t Aligned_num, uint8_t bMotorNbr)
{
  return(((_CSPD)this)->Methods_str.pSPD_CalcAngle(this, pInputVars_str, Aligned_num, bMotorNbr));
}
