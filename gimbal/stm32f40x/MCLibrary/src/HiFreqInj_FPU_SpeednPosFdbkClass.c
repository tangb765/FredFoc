...
static int16_t HFI_FP_SPD_CalcElAngle(CSPD this, void *pInputVars_str, int32_t Aligned_num, uint8_t bMotorNbr);
static bool HFI_FP_SPD_CalcAvrgMecSpeed01Hz(CSPD this, int16_t *hMecSpeed01Hz);
static int32_t HFI_FP_SPD_SetMecAngle(CSPD this, int16_t hMecAngle);
